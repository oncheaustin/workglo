...
?>
<div class="container mt-3"> <!-- Container starts -->
<div class="row">
    ...
    <div class="carousel-inner">
        ...
        ?>
          <div class="carousel-item active">
            ...
            <img src="slides_images/<?php echo $slide_image; ?>" alt="Los Angeles" class="img-fluid">
...
<div class="col-md-12">
<h2 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?>"><?php echo $lang['user_home']['featured_proposals']; ?></h2>
<button onclick="location.href='featured_proposals'" class="<?=($lang_dir == "right" ? 'float-left':'float-right')?> btn btn-success"><?php echo $lang['view_all']; ?></button>
</div>
</div>
<div class="row">
    <?php
    ...
    if($count_proposals == 0){
        echo "<p class='text-muted' style='position:relative; left: 35%;'><i class='fa fa-frown-o'></i> {$lang['user_home']['no_featured_proposals']} </p>";
    }
...
<div class="row mb-3">
<div class="col-md-12">
<h2 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?>"><?php echo $lang['user_home']['top_proposals']; ?></h2>
<button onclick="location.href='top_proposals'" class="<?=($lang_dir == "right" ? 'float-left':'float-right')?> btn btn-success"><?php echo $lang['view_all']; ?></button>
</div>
</div>
<div class="row">
    <?php
    $get_proposals = $db->query("select * from proposals where level_id='4' and proposal_status='active' LIMIT 0,8");
    $count_proposals = $get_proposals->rowCount();
    if($count_proposals == 0){
        echo "<p class='text-muted' style='position:relative; left: 35%;'><i class='fa fa-frown-o'></i> {$lang['user_home']['no_top_proposals']}</p>";
    }
    while($row_proposals = $get_proposals->fetch()){
    $proposal_id = $row_proposals->proposal_id;
    $proposal_title = $row_proposals->proposal_title;
...
<div class="row mb-3">
<div class="col-md-12">
<h2 class="pl-0 pr-0 ml-0 mr-0 <?=($lang_dir == "right" ? 'float-right':'float-left')?>"><?php echo $lang['user_home']['random_proposals']; ?></h2>
<button onclick="location.href='random_proposals'" class="<?=($lang_dir == "right" ? 'float-left':'float-right')?> btn btn-success"><?php echo $lang['view_all']; ?></button>
</div>
</div>
<div class="row">
    <?php
    ...
    $count_proposals = $get_proposals->rowCount();
    if($count_proposals == 0){
        echo "<p class='text-muted' style='position:relative; left: 35%;'><i class='fa fa-frown-o'></i> {$lang['user_home']['no_random_proposals']}</p>";
    }
    while($row_proposals = $get_proposals->fetch()){
    $proposal_id = $row_proposals->proposal_id;
    $proposal_title = $row_proposals->proposal_title;
...
if(!empty($count_proposals)){
?>
<div class="row mt-2 mb-3">
<div class="col-md-12">
<h2 class="<?=($lang_dir == "right" ? 'float-right':'float-left')?>"><?php echo $lang['user_home']['recent_requests']; ?></h2>
<button type="button" onclick="location.href='requests/buyer_requests'" class="<?=($lang_dir == "right" ? 'float-left':'float-right')?> btn btn-success"><?php echo $lang['view_all']; ?></button>
</div>
</div>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <?php
                ...
                $run_requests_count = $select_requests->rowCount();
            ...
            <tr id="request_tr_<?php echo $request_id; ?>">
                ...
                <?php } ?>
                    <div class="request-description">
                        <h6><?php echo ucfirst($request_seller_user_name); ?></h6>
                        <h6 class="text-success"><?php echo $request_title; ?></h6>

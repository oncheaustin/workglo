                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="index?delete_article_cat=<?php echo $article_cat_id; ?>" onclick="return confirm('You are about to delete this category, do you wish to proceed ?');" class="btn btn-danger">

                                            <i class="fa fa-trash text-white" ></i> <span class="text-white">Delete</span>

                                        </a>

                                        <a href="index?edit_article_cat=<?php echo $article_cat_id; ?>"  class="btn btn-success">

                     ...
                     ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="index?delete_child_cat=<?php echo $child_id; ?>" onclick="return confirm('Do you really want to delete this sub category permanently.');" class="btn btn-danger">
                            ...
                            <td>
                                ...
                                <a href="index?edit_child_cat=<?php echo $child_id; ?>" class="btn btn-success">

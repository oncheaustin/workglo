...
$page = $input->get('proposals_files_pagination');
...
?>
                    <img src="../proposals/proposal_files/<?php echo $files_array[$i]; ?>" class="img-fluid">
            ...
            <div class="card-footer">
                ...
                <a href="../proposals/proposal_files/<?php echo $files_array[$i]; ?>" download class="float-left">
...
<a href='index?proposals_files_pagination=1' class='page-link'> First Page </a>
...
<a href='index?proposals_files_pagination=".$i."' class='page-link'>".$i."</a>
...
<a href='index?proposals_files_pagination=$total_pages' class='page-link'> Last Page </a>

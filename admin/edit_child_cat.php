...
$update_child_cat = $db->update("categories_children",array("child_parent_id" => $parent_cat),array("child_id" => $child_id));
		
if($update_child_cat){

$update_meta = $db->update("child_cats_meta",array("child_title" => $child_title,"child_desc" => $child_desc),array("child_id" => $child_id, "language_id" => $adminLanguage));

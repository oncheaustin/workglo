         ...
         <div class="card-header bg-primary">
             ...
             <div class="row">
                 ...
                 <div class="col-9 text-right">
                     ...
                     <div class="huge"><?php echo $count_proposals; ?>  <span class="badge badge-danger">Proposals</span></div>
                     Pending Approval
                            ...
                            <table class="table table-bordered links-table">
                              ...
                              <tbody>
                                <tr onclick="location.href='index?view_support_requests'">
                                  ...
                                  <td><span class="badge badge-success"><?php echo $count_support_tickets; ?></span></td>
                                </tr>
                                  
                                  <tr onclick="location.href='index?view_proposals'">
                                  <td>Proposals/Services Awaiting Approval</td>
                                  <td><span class="badge badge-success"><?php echo $count_proposals; ?></span></td>
                                </tr>
                                  
                                  <tr onclick="location.href='index?buyer_requests'">
                                  <td>Buyer Requests Awaiting Approval</td>
                                  <td><span class="badge badge-success"><?php echo $count_requests; ?></span></td>
                                </tr>
                                  
                                  <tr onclick="location.href='index?view_referrals'">
                                  <td>Referrals Awaiting Approval</td>
                                  <td><span class="badge badge-success"><?php echo $count_referrals; ?></span></td>
                                </tr>
                            ...
                            <div class="card-body">
                                <div class="mx-auto d-block">
                                    ...
                                    <?php if(!empty($admin_image)){ ?>
                                        <img class="rounded-circle mx-auto d-block" src="admin_images/<?php echo $admin_image; ?>" alt="Card image cap" width="145px">
                                    ...
                                    <h5 class="text-sm-center mt-2 mb-1"><?php echo strtoupper($admin_name); ?></h5>
                                    <div class="location text-sm-center"><i class="fa fa-map-marker"></i> <?php echo strtoupper($admin_country); ?></div>
                                </div>
                                <hr>
                                <div class="card-text text-sm-center">
                                    <span class="badge badge-success"><?php echo strtoupper($admin_job); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>

    ...
    <div class="card">
        ...
        <div class="card-body row">
            ...
            <div class="col-md-10">
                ...
                <h1 class="float-right"><?= $s_currency; ?>
                    <?= $order_price; ?>.00</h1>
                ...
                <table class="order-table table mt-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $s_currency.$order_price; ?>.00</td>
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                ...
                                <span class="float-right mr-5"> <b>Total : </b> <?= $s_currency; ?><?= $total; ?>.00 </span>
                ...
                ?>
                    ...
                    <div class="message-div">
                        ...
                        <p class="message-desc">
                            ...
                            <a href="../order_files/<?= $file; ?>" download class="d-block mt-2 ml-1">
                    ...
                    <div class="message-div">
                        ...
                        <p class="message-desc">
                            ...
                            <a href="../order_files/<?= $file; ?>" download class="d-block mt-2 ml-1 text-primary">

...
<div class="container">
    ...
    <div class="row">
		...
		<td><?php echo $article_heading; ?></td> 
		<td><?php echo $article_cat_title; ?></td> 
		<td><?php echo $right_image; ?></td> 
		<td><?php echo $top_image; ?></td> 
		<td><?php echo $bottom_image; ?></td> 
		<td><?php echo $article_status; ?></td>
		
		<td>
        		
        <a href="index?edit_article=<?php echo $article_id; ?>" class="text-success">

        Edit 

        </a> |

        <a href="index?delete_article=<?php echo $article_id; ?>" class="text-success">

                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           ...
                                           <a href="index?delete_seller_language=<?php echo $language_id; ?>" onclick="return confirm('You are about to delete this language perminently. Proceed?');" class="btn btn-danger">
                                        ...
                                        <td>
                                            ...
                                            <a href="index?edit_seller_language=<?php echo $language_id; ?>" class="btn btn-success">

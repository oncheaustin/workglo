...
<div class="card-body"><!--- card-body Starts --->
    ...
    <h4 class="mb-4"> User Summary <small>All Users (<?php echo $count_sellers; ?>)</small> </h4>
        ...
        <table class="table table-bordered"><!--- table table-bordered table-hover Starts --->
            ...
            <thead><!--- thead Starts --->
                ...
                <tr>
                    ...
                    <!-- <th>Seller's Balance</th> -->

                    <th>Seller's Register Date</th>
                        ...
                        <td width="210px;">
                            ...
                            <button class="btn btn-success dropdown-toggle" type="button" data-toggle="dropdown">Actions</button>
                                ...
                                <div class="dropdown-menu"><!--- dropdown-menu Starts --->
                                    ...
                                    <a target="_blank" class="dropdown-item" href="index?seller_login=<?php echo $seller_user_name; ?>">

                                        <i class="fa fa-sign-in"></i> Login As <?php echo $seller_user_name; ?>

                                    </a>

                                        
                                    <a class="dropdown-item" href="index?update_balance=<?php echo $seller_id; ?>">

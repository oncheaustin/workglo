...
$insert_card = $db->insert("home_cards",array("language_id" => $adminLanguage,"card_title" => $card_title,"card_desc" => $card_desc,"card_link" => $card_link,"card_image" => $card_image));
...
echo "<script>
          ...
          type: 'success',
          text: 'card Successfully Inserted!',
          timer: 4000,
          onOpen: function(){
          swal.showLoading()
          }

...
<i class="fa fa-money-bill-alt fa-fw"></i> Edit card
...
<input type="text" name="card_title" class="form-control" value="<?php echo $card_title; ?>" required="">
...
<textarea name="card_description" class="form-control" cols="6" required=""><?php echo $card_desc; ?></textarea>
...
<input type="text" name="card_link" class="form-control" value="<?php echo $card_link; ?>">
...
<br><img src="../card_images/<?php if(empty($b_image)){echo "no.jpg"; }else{echo $b_image;} ?>" width="70">
...
move_uploaded_file($tmp_name,"../card_images/$card_image");
...
$update_card = $db->update("home_cards",array("card_title" => $card_title,"card_desc" => $card_desc,"card_link" => $card_link,"card_image" => $card_image),array("card_id" => $card_id));

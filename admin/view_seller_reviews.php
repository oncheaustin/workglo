                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="index?single_seller=<?php echo $review_seller_id; ?>">
                        ...
                        <td>
                            <?php echo $seller_rating; ?>
                        </td>

                        <td>

                            <a href="index?delete_seller_review=<?php echo $review_id; ?>" class="btn btn-danger" onclick="return confirm('Do you really want to perminently delete this review?')">

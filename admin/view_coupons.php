                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <?php if($coupon_type == "fixed_price"){ ?>
                                            <?php echo $s_currency; ?><?php echo $coupon_price; ?>
                                        <?php }else{ ?>
                                       ...
                                       <?php } ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="index?delete_coupon=<?php echo $coupon_id; ?>" class="btn btn-danger">
                                        ...
                                        <td>
                                            ...
                                            <a href="index?edit_coupon=<?php echo $coupon_id; ?>" class="btn btn-success">

                    ...
                    <form action="" method="post" enctype="multipart/form-data"><!--- form Starts --->
                        ...
                        <div class="form-group row"><!--- form-group row Starts --->
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="slide_name" class="form-control" required value="<?php echo $s_name; ?>">
                        ...
                        <div class="form-group row"><!--- form-group row Starts --->
                            ...
                            <div class="col-md-6">
                                ...
                                <img src="../home_slider_images/<?php echo $s_image; ?>" width="100" height="40">
...
move_uploaded_file($tmp_slide_image,"../home_slider_images/$slide_image");

$update_slide = $db->update("home_section_slider",array("slide_name" => $slide_name,"slide_image" => $slide_image),array("slide_id" => $edit_id));

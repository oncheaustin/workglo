...
<a href="../conversations/conversations_files/<?php echo $message_file; ?>" download class="d-block mt-2 ml-1 text-primary">
...
<p class="d-block d-sm-none"> <b> Price / Amount : </b> <?php echo $s_currency; ?><?php echo $amount; ?> </p>

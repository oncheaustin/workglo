                            ...
                            <div class="col-lg-4 col-md-6 mb-3"><!--- col-lg-4 col-md-6 mb-3 Starts --->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="index?delete_term=<?php echo $term_id; ?>" class="float-left btn btn-danger" title="Delete">
                                        ...
                                        <a href="index?edit_term=<?php echo $term_id; ?>" class="float-right btn btn-success" title="Edit">

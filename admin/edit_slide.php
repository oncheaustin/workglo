                    ...
                    <form action="" method="post" enctype="multipart/form-data"><!--- form Starts --->
                        ...
                        <div class="form-group row"><!--- form-group row Starts --->
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="url" name="slide_url" class="form-control" required value="<?php echo $s_url; ?>">
...
$update_slide = $db->update("slider",array("slide_name" => $slide_name,"slide_desc" => $slide_desc,"slide_image" => $slide_image),array("slide_id" => $edit_id)); 

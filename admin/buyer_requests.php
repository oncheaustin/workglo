    ...
    <div class="row"><!--- 2 row Starts --->
        ...
        <div class="col-lg-12"><!--- col-lg-12 Starts --->
            ...
            <div class="card"><!--- card Starts --->
                ...
                All (<?php echo $count_all_requests; ?>)
                ...
                Active (<?php echo $count_active_requests; ?>)
                ...
                Pending (<?php echo $count_pending_requests; ?>)
                ...
                Declined (<?php echo $count_unapproved_requests; ?>)
                ...
                Paused (<?php echo $count_pause_requests; ?>)
                        ...
                        <table class="table table-bordered">
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <a href="../requests/request_files/<?php echo $request_file; ?>" download class="text-primary">
                                        ...
                                        <td>
                                            ...
                                            <?php if(!empty($request_budget)){ ?> <?php echo $s_currency; ?>
                                        ...
                                        <td><?php echo ucfirst($request_status); ?></td>

                                        <td>

                                        <?php if($request_status == "pending"){ ?>

                                            <a href="index?approve_request=<?php echo $request_id; ?>" class="btn btn-success" onclick="return confirm('You are about to approve this request. Continue?')">
                                            ...
                                            <a href="index?unapprove_request=<?php echo $request_id; ?>" class="btn  pt-1" onclick="return confirm('You are about to delete this request perminently. Continue?')" style="background-color:red;">
                                        ...
                                        <a href="index?delete_request=<?php echo $request_id; ?>" class="btn btn-danger pt-1" onclick="return confirm('You are about to delete this request perminently. Continue?')">

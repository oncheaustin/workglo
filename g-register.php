...
<head>
<title> <?php echo $site_name; ?> - Google Registration </title>
...
<img class="logo img-fluid" src="<?php echo $_SESSION['picture']; ?>">
<?php 
...
<input type="text" class="form-control" name="name" value="<?php echo $_SESSION['givenName'] . "" . $_SESSION['familyName']; ?>" placeholder="Enter Your Full Name" required>
</div><!-- form-group Ends -->
<div class="form-group"><!-- form-group Starts -->
...
<input type="email" class="form-control" disabled name="email" value="<?php echo $_SESSION['email'] ?>" placeholder="Enter Your Email" required>
</div><!-- form-group Ends -->

<div class="card mb-3 contacts-sidebar">
	<div class="card-header">
		<h5 class="h5"><i class="fa fa-address-book "></i> My Contacts</h5>
				...
				<div class="table-responsive">
					<table class="table table-bordered">
						...
						<tr>
						    ...
						    <h6 class="make-black"><?php echo $buyer_user_name; ?> </h6>
						    <a href="<?php echo $buyer_user_name; ?>" target="_blank" class="text-success">
						     User Profile </a>
						    <span style="color:black;">|</span>
						    <a href="conversations/message?seller_id=<?php echo $buyer_id; ?>" target="_blank" class="text-success">  Chat History </a>
							</div>
							</td>
						</tr>
						<?php } ?>
						...
						<tbody>
							...
							<tr>
								<td>
									...
									<div class="contact-title">
										<h6 class="make-black"><?php echo $seller_user_name; ?></h6>
										<a href="<?php echo $seller_user_name; ?>" target="_blank" class="text-success">
										 User Profile </a>
										  <span style="color:black;">|</span>
										<a href="conversations/message?seller_id=<?php echo $seller_id; ?>" target="_blank" class="text-success"> Chat History </a>
									</div>
								</td>
							</tr>
                            <?php } ?>

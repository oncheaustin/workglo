<div class="card rounded-0 mb-3 welcome-box"><!-- card rounded-0 mb-3 welcome-box Starts -->
	...
	<img src="user_images/<?php echo $seller_image; ?>" class="img-fluid rounded-circle mb-3">
	<?php }else{ ?>
...
<div class="rounded-0 carosel_sec">
	<h3 class="buy_head <?=($lang_dir == "right" ? 'text-right':'')?>"><?php echo $lang['buy_it_again']; ?></h3>
		<?php 
  ...
  <div id="demo" class="carousel slide" data-ride="carousel"><!-- The slideshow -->
	   ...
	   <div class="proposal-card-base mp-proposal-card"><!--- proposal-card-base mp-proposal-card Starts --->
	     <a href="<?= $site_url; ?>/proposals/<?php echo $seller_user_name; ?>/<?php echo $proposal_url; ?>">
	     ...
	     <a href="<?= $site_url; ?>/<?php echo $seller_user_name; ?>" class="seller-name"><?php echo $seller_user_name; ?></a>
	     <div class="gig-seller-tooltip">
	     <?php echo $seller_level; ?>
	     </div>
	     </div>
	     </div><!--- gig-seller-info Ends --->
	     <a href="<?= $site_url; ?>/proposals/<?php echo $seller_user_name; ?>/<?php echo $proposal_url; ?>" class="proposal-link-main">
...
<h3 class="buy_head <?=($lang_dir == "right" ? 'text-right':'')?>"><?php echo $lang['recently_viewed']; ?></h3>
  <?php
...
<div class="proposal-card-base mp-proposal-card"><!--- proposal-card-base mp-proposal-card Starts --->
    <a href="proposals/<?php echo $seller_user_name; ?>/<?php echo $proposal_url; ?>">
    <img src="proposals/proposal_files/<?php echo $proposal_img1; ?>" class="img-fluid">
    </a>
    <div class="proposal-card-caption"><!--- proposal-card-caption Starts --->
    <div class="proposal-seller-info"><!--- gig-seller-info Starts --->
...
<div class="card rounded-0 sticky-start mb-3 card_user">
	...
	<h4><?php echo $lang['start_selling']['title']; ?></h4>
	<p><?php echo $lang['start_selling']['desc']; ?></p>
	<button onclick="location.href='start_selling'" class="btn get_btn"><?php echo $lang['start_selling']['button']; ?></button>
	</div>
</div>
<br>
<script>

...
$data['notifications'][$i]['sender_image'] = "admin/admin_images/" . $get_admin->fetch()->admin_image;

}

$data['notifications'][$i]['message'] = include("notification_reasons.php");

if($status == 'unread'){ $data['notifications'][$i]['class'] = 'header-message-div-unread'; }else{ $data['notifications'][$i]['class'] = 'header-message-div';	}

...
$inboxQuery = "select * from inbox_sellers where (receiver_id=:r_id or sender_id=:s_id) AND NOT message_status='empty' order by message_status='unread' DESC LIMIT 0,4";

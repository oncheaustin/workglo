	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				...
				<img src="<?php echo $site_url; ?>/images/level_badge_1.png" >
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				...
				<img src="<?php echo $site_url; ?>/images/level_badge_2.png" >
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				...
				<img src="<?php echo $site_url; ?>/images/level_badge_3.png" >

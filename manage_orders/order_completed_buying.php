...
<div class="table-responsive box-table mt-3">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<a href="order_details?order_id=<?php echo $order_id; ?>">
    ...
    <?php
            ...
            if( $count_orders == 0){
                ...
                echo "<center><h3 class='pb-4 pt-4'><i class='fa fa-meh-o'></i> No proposals/services purchased have been completed yet.</h3></center>";
            }

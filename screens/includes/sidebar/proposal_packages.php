<div class="card-header pt-0 pl-3 tabs-header">
	...
	?>
	<li class="nav-item">
		<a class="nav-link <?=($lang_dir == "right" ? 'text-right':'')?> <?php if($package_name == "Standard"){ echo " active"; } ?>" href="#tab_<?php echo $package_id; ?>" data-toggle="tab" formid="checkoutForm<?php echo $i; ?>">

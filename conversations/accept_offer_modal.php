...
<div id="accept-offer-modal" class="modal">
	...
	<div class="modal-dialog">
				...
				<div class="order-details">
					...
					<div class="request-div">
						...
						<h4 class="mb-3">
							...
							<span class="total-price float-right d-sm-block d-none"> <?php echo $s_currency; ?><?php echo $amount; ?> </span>
						...
						<p> <b> Price: </b> <?php echo $s_currency; ?><?php echo $amount; ?> </p>

						<p class="processing-fee"> <b> Processing Fee: </b> <?php echo $s_currency; ?><?php echo $processing_fee; ?> </p>
		...
		data-image="<?php echo $site_url; ?>/images/<?php echo $site_logo_image; ?>"
		...
		<form action="https://secure.payza.eu/checkout" method="post" id="payza-form">
		    ...
		    <input type="hidden" name="ap_returnurl" value="<?php echo $site_url; ?>/payza_order?message_offer_id=<?php echo $offer_id; ?>"/>
		    
		    <input type="hidden" name="ap_cancelurl" value="<?php echo $site_url; ?>/conversations/insert_message.php?single_message_id=<?php echo $single_message_id; ?>"/>
		...
		<form action="https://www.coinpayments.net/index.php" method="post" id="coinpayments-form">
			...
			<input type="hidden" name="success_url" value="<?php echo $site_url; ?>/crypto_order?message_offer_id=<?php echo $offer_id; ?>">
		
			<input type="hidden" name="cancel_url" value="<?php echo $site_url; ?>/conversations/insert_message.php?single_message_id=<?php echo $single_message_id; ?>">
...
$('.total-price').html('<?php echo $s_currency; ?><?php echo $amount; ?>');

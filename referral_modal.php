...
<h6>If anyone buys this proposal with your unique referral link, you will get <?php echo $proposal_referral_money; ?>% from every purchase.</h6>

<input class="form-control mb-1" disabled value="<?php echo $site_url . "/referral?proposal_id=$proposal_id&referral_code=" . $proposal_referral_code . "&referrer_id=$login_seller_id"; ?>">

...
?>
<option value="<?php echo $delivery_proposal_title; ?>" <?php if(@$form_data['delivery_id'] == $delivery_proposal_title){ echo "selected"; } ?>><?php echo $delivery_proposal_title; ?></option>
<?php } ?>
</select>
</div>
...
if(isset($_POST['submit'])){
  ...
  if($val->run() == false){
    ...
    if($count_proposals ==  1){
      ...
      $insert_package_1 = $db->insert("proposal_packages",array("proposal_id" => $proposal_id,"package_name" => 'Basic', "price" => 5));
      $insert_package_2 = $db->insert("proposal_packages",array("proposal_id" => $proposal_id,"package_name" => 'Standard', "price" => 10));
      $insert_package_3 = $db->insert("proposal_packages",array("proposal_id" => $proposal_id,"package_name" => 'Advance', "price" => 15));
      ...
      swal.showLoading()
        ...
        window.open('edit_proposal?proposal_id=$proposal_id&pricing','_self')
      });
      </script>";
    }

...
<div class="col-md-9"><textarea name="proposal_title" rows="2" placeholder="I Will" required="" class="form-control"><?php echo $d_proposal_title; ?></textarea></div>
...
<input type="number" name="proposal_referral_money" class="form-control" min="1" max="100" value="<?php echo $d_proposal_referral_money; ?>">
...
<div class="col-md-9"><input type="text" name="proposal_tags" class="form-control" data-role="tagsinput" value="<?php echo $d_proposal_tags; ?>"></div>

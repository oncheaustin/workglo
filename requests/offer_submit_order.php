...
<div id="offer-order-modal" class="modal fade">
	...
	<div class="modal-dialog">
			...
			<div class="modal-body">
				...
				<div class="order-details">
					...
					<div class="offer-div"><!-- offer-div Starts -->
						...
						<span class="price float-right"> <?php echo $s_currency; ?><?php echo $amount; ?> </span>
            ...
            ?>
             ...
             <form action="stripe_charge" method="post" id="credit-card-form">
				...
				<input
                    ...
                    data-image="<?php echo $site_url; ?>/images/<?php echo $get_site_logo_image ?>"
		...
		<form action="https://secure.payza.eu/checkout" method="post" id="payza-form">
		    ...
		    <input type="hidden" name="ap_returnurl" value="<?php echo $site_url; ?>/payza_order?view_offers=1&offer_id=<?php echo $offer_id; ?>"/>
		    
		    <input type="hidden" name="ap_cancelurl" value="<?php echo $site_url; ?>/requests/view_offers?request_id=<?php echo $request_id; ?>"/>
		...
		<form action="https://www.coinpayments.net/index.php" method="post" id="coinpayments-form">
			...
			<input type="hidden" name="success_url" value="<?php echo $site_url; ?>/crypto_order?view_offers=1&offer_id=<?php echo $offer_id; ?>">
		
			<input type="hidden" name="cancel_url" value="<?php echo $site_url; ?>/requests/view_offers?request_id=<?php echo $request_id; ?>">
